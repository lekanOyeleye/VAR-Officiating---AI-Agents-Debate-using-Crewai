...
class VarOfficiating():
    ...
    def proposer(self) -> Agent:
        return Agent(
            config=self.agents_config['proposer'], # type: ignore[index]
            verbose=True
        )
    ...
    def opposer(self) -> Agent:
        return Agent(
            config=self.agents_config['opposer'], # type: ignore[index]
            verbose=True
        )
    ...
    @crew
    def crew(self) -> Crew:
        """Creates the VarOfficiating crew"""
